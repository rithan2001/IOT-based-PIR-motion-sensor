...
char ssid[] = "mad";                               // Enter your WiFi SSID (router name)
char pass[] = "8004958816";                             // Enter your WiFi router password
unsigned long myChannelNumber = 515032;                 // Enter your Thingspeak Channel Number
const char * myWriteAPIKey = "EOTISQJK7BXYUSFQ";        // Enter your ThingSpeak API Key
